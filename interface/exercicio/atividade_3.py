...
class Tela:
    def __init__(self, master):
        ...
        self.but1.grid(column=3, row=0, stick=tk.N,  padx=3, pady=0, rowspan=3)

        self.but2 = tk.Button(self.janela, text='2')
        self.but2.grid(column=2, row=1,stick=tk.N, padx=0, rowspan=3)

        self.but3 = tk.Button(self.janela, text='3')
        self.but3.grid(column=3, row=1,stick=tk.N, padx=0, pady=0, rowspan=4)
        ...
        self.but5.grid(column=1, row=2,stick=tk.N, padx=0, pady=0)
